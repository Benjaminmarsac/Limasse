from PyQt5.QtWidgets import (QPushButton, QMainWindow,QComboBox, QLineEdit, QErrorMessage,QLabel)
...
class ScatterPlot(QMainWindow):
    ...
    def plot_button(self):
        ...
        style_parameter = self.style_parameter.currentText() if self.style_parameter.currentText() != "Empty" else None
        x_min = int(self.x_min_parameter.text()) if ((len(self.x_min_parameter.text())) != 0 ) else None
        x_max = int(self.x_max_parameter.text()) if ((len(self.x_max_parameter.text())) != 0 ) else None
        y_min = int(self.y_min_parameter.text()) if ((len(self.y_min_parameter.text())) != 0 ) else None
        y_max = int(self.y_max_parameter.text()) if ((len(self.y_max_parameter.text())) != 0 ) else None
