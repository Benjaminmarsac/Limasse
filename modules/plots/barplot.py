...
class Barplot(QMainWindow):
    ...
    def plot_parameters(self):
        ...
        self.type_parameter.addItems(["None","ocean","binary","gray","winter","spring","autumn","summer"])
    ...
    def plot_button(self):
        ...
        palette_parameter = self.type_parameter.currentText() if self.type_parameter.currentText() != "None" else None
